...
var style_EducationSkillsandTrainingscore_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Education, Skills and Training Score (Decile)");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Education, Skills and Training Score (Decile)") !== null) {
        labelText = String(feature.get("Education, Skills and Training Score (Decile)"));
    }
