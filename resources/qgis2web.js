...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [420123.626746, 374953.270820, 485501.666514, 410334.327637], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:27700',
            //extent: [82668.507812, 5336.965820, 655653.875000, 657536.375000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([420123.626746, 374953.270820, 485501.666514, 410334.327637], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Rotherham Index of Multiple Deprivation 2025 map</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (143 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '*Protoype version of webmap* - Demonstrates the 2025 Indices of Multiple Deprivation for Rotherham MBC, including details of some sub-domains. ';
            }
